...
3. [Debian installation 🌀](#3-debian-installation-)
4. [Virtual machine setup ⚙️](#4-virtual-machine-setup-)

    4.1 [Installing sudo & configuration of users and groups 👤](#41-installing-sudo--configuration-of-users-and-groups-)
    ...
    4.5 [Setting up the strong password policy 🔑](#45-setting-up-the-strong-password-policy-)
    
    4.6 [Connecting via SSH 🗣](#46-connecting-via-ssh-)
    
5. [Script 🚨](#5-script-)

    5.1 [Total result of the script 🆗](#51-total-result-of-the-script)
...
8. [Bonus ⭐](#8-bonus)
    ...
    8.3 [Additional service ➕](#83-additional-service)

9. [Correction sheet ✅](#9-correction-sheet)

    9.1 [Evaluation answers 💯](#91-evaluation-answers)

    9.2 [Evaluation commands ⌨️](#92-evaluation-commands)
